class OrdersToDeliver {
  ...
  OrdersToDeliver({this.dataLists, this.status});

  OrdersToDeliver.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.dataLists != null) {
      data['data_lists'] = this.dataLists!.map((v) => v.toJson()).toList();
    }
...
class Hassender {
  ...
  String? address;
  Null? mapAddress;
  Null? addressLatitude;
  Null? addressLongitude;
  String? slug;
  String? slugDisplay;
  String? gstin;
  String? createdAt;
