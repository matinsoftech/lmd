 class PickUpOrders {
  bool? result;
  List<PickedupOrders>? pickedupOrders;

  PickUpOrders({this.result, this.pickedupOrders});

  PickUpOrders.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    if (json['pickedupOrders'] != null) {
      pickedupOrders = <PickedupOrders>[];
      json['pickedupOrders'].forEach((v) {
        pickedupOrders!.add(new PickedupOrders.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pickedupOrders != null) {
      data['pickedupOrders'] =
          this.pickedupOrders!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class PickedupOrders {
  int? id;
  String? orderId;
  String? date;
  int? orderType;
  ...
  PickedupOrders.fromJson(Map<String, dynamic> json) {
    id = json['id'];
