...
class OrderType {
  ...
  OrderType.fromMap(Map<dynamic, dynamic> json) {
    id = json['id'];
    name = json['name'];
...
class OrderToPickUp {
  bool? result;
  List<OrderToPickUpData>? orderToPickUpData;

  OrderToPickUp({this.result, this.orderToPickUpData});

  OrderToPickUp.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    if (json['orderToPickUpData'] != null) {
      orderToPickUpData = <OrderToPickUpData>[];
      json['orderToPickUpData'].forEach((v) {
        orderToPickUpData!.add(new OrderToPickUpData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.orderToPickUpData != null) {
      data['orderToPickUpData'] =
          this.orderToPickUpData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class OrderToPickUpData {
  int? id;
  String? orderId;
  String? date;
  int? orderType;
  ...
  OrderToPickUpData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    hasreceiver = json['hasreceiver'] != null
        ...
        : null;
    hasdriver = json['hasdriver'] != null
        ? new Hasdriver.fromJson(json['hasdriver'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.hasdriver != null) {
      data['hasdriver'] = this.hasdriver!.toJson();
    }
    return data;
  }
}
...
class Hasdriver {
  ...
  Hasdriver.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    orderId = json['order_id'];
    driverId = json['driver_id'];
    orderPickedup = json['order_pickedup'];
    slug = json['slug'];
    slugDisplay = json['slug_display'];
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['order_pickedup'] = this.orderPickedup;
    data['slug'] = this.slug;
    data['slug_display'] = this.slugDisplay;
    data['created_at'] = this.createdAt;
    data['updated_at'] = this.updatedAt;
