...
class OrderDetailPageForPickedUp extends StatelessWidget {
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Consumer<OrderProvider>(builder: (context, provider, child) {
              String od = '${provider.pickedUpOrders[index].hasordertype!.name}';
              ...
              return Column(
                ...
                children: [
                  ...
                  Text("${provider.pickedUpOrders[index].orderId}",
                      style: TextStyle(
                  ...
                  //Weight
                  Text(provider.pickedUpOrders[index].hascourier!
                              .weightQuantity !=
                          null
                      ? "Weight(kg)"
                      : "Volume"),
                  Text(
                      provider.pickedUpOrders[index].hascourier!
                                  .weightQuantity !=
                              null
                          ? provider.pickedUpOrders[index].hascourier!.actWeight
                              .toString()
                          : provider.pickedUpOrders[index].hascourier!.quantity
                              .toString(),
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
...
//                       )),
                  ...
                  const Text("Order type",
                      style: TextStyle(color: Colors.black54)),
                  Text(
                      "${provider.pickedUpOrders[index].hasordertype!.name![0].toUpperCase()}${provider.pickedUpOrders[index].hasordertype!.name!.substring(1)}",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      )),
