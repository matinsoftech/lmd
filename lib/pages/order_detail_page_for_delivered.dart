...
class OrderDetailPageForDelivered extends StatelessWidget {
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Consumer<OrderProvider>(builder: (context, provider, child) {
              String od =
                  '${provider.ordersDelivered[index].hasordertype!.name}';
              ...
              return Column(
                ...
                children: [
                  ...
                  Text("${provider.ordersDelivered[index].orderId}",
                      style: TextStyle(
                  ...
                  //Weight
                  Text(provider.ordersDelivered[index].hascourier!
                              .weightQuantity !=
                          null
                      ? "Weight(kg)"
                      : "Volume"),
                  Text(
                      provider.ordersDelivered[index].hascourier!
                                  .weightQuantity !=
                              null
                          ? provider
                              .ordersDelivered[index].hascourier!.actWeight
                              .toString()
                          : provider.ordersDelivered[index].hascourier!.quantity
                              .toString(),
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
...
//                       )),
                  ...
                  const Text("Order type",
                      style: TextStyle(color: Colors.black54)),
                  Text(
                      "${provider.ordersDelivered[index].hasordertype!.name![0].toUpperCase()}${provider.ordersDelivered[index].hasordertype!.name!.substring(1)}",
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      )),
