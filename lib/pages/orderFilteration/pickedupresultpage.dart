...
class FilterOrderResultPagePicked extends StatefulWidget {
  final String? fromDate;
  final String? toDate;
  const FilterOrderResultPagePicked({super.key, required this.fromDate, required this.toDate});

  @override
  State<FilterOrderResultPagePicked> createState() => _FilterOrderResultPagePickedState();
}

class _FilterOrderResultPagePickedState extends State<FilterOrderResultPagePicked> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        title: const Text("Pick Up Order",style:TextStyle(color:Colors.black,fontSize: 18)),
   ...
   Widget picked() {
    ...
    final filteredOrders = provider.pickedUpOrders.where((order){
